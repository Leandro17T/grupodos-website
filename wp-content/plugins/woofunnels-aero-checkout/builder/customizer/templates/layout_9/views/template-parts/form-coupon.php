...
if ( $is_disable_coupon || true == wc_string_to_bool( $is_disable_coupon ) ) {
	return;
}
...
$apply_coupon_button_text  = apply_filters( 'wfacp_collapsible_apply_coupon_button_text', __( 'Apply', 'woofunnels-aero-checkout' ) );
