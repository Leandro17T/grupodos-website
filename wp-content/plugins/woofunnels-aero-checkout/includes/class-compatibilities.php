	...
	class WFACP_Plugin_Compatibilities {
		...
		public static function plugin_loaded() {
			$files = array(
				...
				'plugins/class-wc-post-nl.php'                                   => class_exists( 'WCPOST' ) || class_exists( 'WooCommerce_PostNL' ) || function_exists( 'PostNLWooCommerce\postnl' ),
		...
		public static function setup_theme() {
			$files = [
				...
				'fields/class-wfacp-fattura-24.php'                     => defined( 'FATT_24_PLUGIN_DATA' ),
