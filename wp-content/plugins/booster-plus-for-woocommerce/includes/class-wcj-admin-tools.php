...
if ( ! class_exists( 'WCJ_Admin_Tools' ) ) :
	...
	class WCJ_Admin_Tools extends WCJ_Module {
		...
		public function __construct() {
			...
			$this->desc       = __( 'Booster Plus for WooCommerce general back-end tools. Enable interface by user roles (Plus). Custom shop manager editable roles (Plus).', 'woocommerce-jetpack' );
			$this->desc_pro   = __( 'Booster Plus for WooCommerce general back-end tools.', 'woocommerce-jetpack' );
