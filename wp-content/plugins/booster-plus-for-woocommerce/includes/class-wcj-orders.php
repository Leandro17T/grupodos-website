	...
	class WCJ_Orders extends WCJ_Module {
		...
		public function handle_bulk_actions_regenerate_download_permissions( $redirect_to, $doaction, $post_ids ) {
			...
			$redirect_to = esc_url_raw(
				add_query_arg(
					array(
						'wcj_bulk_regenerated_download_permissions' => count( $post_ids ),
		...
		public function admin_notice_regenerate_download_permissions() {
			$wpnonce = isset( $_REQUEST['wcj_bulk_regenerated_download_permissions-nonce'] ) ? wp_verify_nonce( sanitize_key( $_REQUEST['wcj_bulk_regenerated_download_permissions-nonce'] ), 'wcj_bulk_regenerated_download_permissions' ) : false;
