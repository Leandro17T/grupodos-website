...
if ( ! class_exists( 'WCJ_Multicurrency' ) ) :
	...
	class WCJ_Multicurrency extends WCJ_Module {
		...
		public function save_price( $price, $product_id, $filter ) {
			WCJ()->all_modules['multicurrency']->calculated_products_prices[ $product_id ][ $filter ] = $price;
		}
		...
		public function change_price( $price, $_product, $args = null ) {
			...
			if ( $do_save && isset( WCJ()->all_modules['multicurrency']->calculated_products_prices[ $_product_id ][ $_current_filter ] ) ) {
				return WCJ()->all_modules['multicurrency']->calculated_products_prices[ $_product_id ][ $_current_filter ];
			}
