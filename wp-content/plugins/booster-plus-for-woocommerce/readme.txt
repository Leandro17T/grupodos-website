...
* FIXED - Fixed Security vulnerability fixes - Multiple CSRF.
...
* FIXED - Added some Security vulnerability fixes.
* FIXED - PHP Notice: Undefined Variable "_SESSION" in /includes/shortcodes/class-wcj-shortcodes-general.php...
